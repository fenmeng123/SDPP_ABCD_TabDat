...
| Common |                                                  | Novel Technology |                                                | Imaging-related Variables |                                                         |
|--------|--------------------------------------------------|------------------|------------------------------------------------|---------------------------|---------------------------------------------------------|
| T0     | Baseline wave                                    | OS               | OwnerShip                                      | QC                        | Quality Control of MRI                                  |
| T1     | One-year follow-up wave                          | STQ              | Screen Time Questionnaire                      | RecInc                    | Recommended Image Inclusion                             |
| T2     | Two-year follow-up wave                          | TPD              | TyPical Day (prefix) or Time Per Day (postfix) | HM                        | Head Motion                                             |
| T3     | Three-year follow-up wave                        | TPW              | Time Per Week                                  | MeanFD                    | Mean Frame-wise Displacement                            |
| T4     | Four-year follow-up wave                         | open             | calculated value from open-answered STQ items  | sMRI                      | Structural MRI                                          |
| MVA    | Missing Value Analysis                           | weekday          | in a typical weekday                           | rsfMRI                    | Resting-state functional MRI                            |
| MI     | Multiple Imputation                              | weekend          | in a typical weekend day                       | RSFNC                     | Resting-state Functional canonical Network Connectivity |
| VSO    | Variable-values Summary Overview                 | School           | School-related work                            | tfMRI                     | Task-based functional MRI                               |
| Rep    | auto-generated Report                            | SMQ              | Social Media Questionnaire                     | MID                       | Monetary Incentive Delay task                           |
| Reorg  | Re-organized data                                | SOC              | SOCial media apps                              | SST                       | Stop Signal Task                                        |
| Rec    | Re-coded data                                    | SMAS             | bergen Social Media Addiction Scale            | Enback                    | Emotional N-back task                                   |
| Raw    | Raw data                                         | MVOC             | Multiplayer Videogame Online Chatting          | Behav                     | Behavioral Performance during task-based fMRI           |
| Imp    | Imputed data                                     | UM               | Use Most                                       | DTI                       | Diffusion MRI - Diffusion Tensor Imaging                |
| Comp   | Compare                                          | NOFE             | the Number Of FollowErs                        | RSI                       | Diffusion MRI - Restriction Spectrum Imaging            |
| ALL    | all avaiable waves in ABCD 5.0                   | NOFI             | the Number Of FollowIngs                       |                           |                                                         |
| S      | Summary (when as postfix of files)               | NOA              | the Number Of Account                          |                           |                                                         |
| Sum    | Sum Scores (when as postfix of variable names)   | MP               | Mobile Phone                                   |                           |                                                         |
| P      | Parent-reported About Youth                      | MPIQ             | Mobile Phone Involvement Questionnaire         |                           |                                                         |
| Y      | Youth Self-reported                              | VGAS             | Video Game Addiction Scale                     |                           |                                                         |
| SMA    | Screen Media Activity                            | ODQ              | Online Dating Questionnaire                    |                           |                                                         |
| MH     | Mental Health                                    | SUAB             | Screen Usage Around Bedtime                    |                           |                                                         |
| ASEBA  | Achenbach System of Empirically Based Assessment |                  |                                                |                           |                                                         |
| NC     | Neuro-Cognition                                  |                  |                                                |                           |                                                         |
| MRI    | Magnetic Resonance Imaging                       |                  |                                                |                           |                                                         |
| CE     | Culture and Environment                          |                  |                                                |                           |                                                         |
| PH     | Physical Health                                  |                  |                                                |                           |                                                         |
| SU     | Substance Use                                    |                  |                                                |                           |                                                         |
| Ge     | Genetics                                         |                  |                                                |                           |                                                         |
| LED    | Linked External Data                             |


| Neurocognition |                                             | Mental Health     |                                                                             | ASEBA Measures |                                                                      |
|----------------|---------------------------------------------|-------------------|-----------------------------------------------------------------------------|----------------|----------------------------------------------------------------------|
| NIHTB          | The NIH Cognition Toolbox                   | BIS               | Behavioral Inhibition System (subscale in BIS/BAS)                          | CBCL           | Child Behavior Checklist                                             |
| PVT            | Picture Vocabulary Task                     | BAS               | Behavioral Activation System (Subscale in BIS/BAS)                          | AnxDep         | CBCL Syndrom Scale - Anxious/Depressed                               |
| FICAT          | Flanker Inhibitory Control & Attention Task | BAS_FS            | BAS Subscale-Fun Seeking (Sum Score)                                        | WithDep        | CBCL Syndrome Scale - Withdrawn/Depressed                            |
| PSMT           | Picture Sequence Memory Task                | BAS_Drive         | BAS Subscale-Drive (Sum Score)                                              | SomaticCo      | CBCL Syndrome Scale - Somatic Complaints                             |
| DCCST          | Dimensional Change Card Sort Task           | BAS_RR            | BAS Subscale-Reward Responsiveness (Sum Score)                              | Social         | CBCL Syndrome Scale - Social Problems                                |
| PCST           | Pattern Comparison processing Speed Task    | PEQ               | Peer Experiences Questionnaire                                              | Thought        | CBCL Syndrome Scale - Thought Problems                               |
| ORRT           | Oral Reading Recognition Task               | Overt             | PEQ Subscale - Overt Aggression or Victimization                            | Attention      | CBCL Syndrome Scale - Attention Problems                             |
| LSWMT          |  List Sorting Working Memory Task           | Rel               | PEQ Subscale - Relational Aggression or Victimization                       | RuleBreak      | CBCL Syndrome Scale - Rule-breaking Behavior                         |
| Cryst          | Crystalized Intelligence Composite Score    | Rep               | PEQ Subscale - Reputational Aggression or Victimization                     | Aggressive     | CBCL Syndrome Scale - Aggressive Behavior                            |
| Fluid          | Fluid Intelligence Composite Score          | Agg               | PEQ Subscale - Dimension - Aggression                                       | Internal       | CBCL Composite Score - Internealizing Problems                       |
| Total          | Total Intelligence Composite Score          | Vic               | PEQ Subscale - Dimension - Victimization                                    | External       | CBCL Composite Score - Externalizing Problems                        |
|                |                                             | PPS               | Prodromal Psychosis Scale                                                   | TotProb        | CBCL Composite Score - Total Problems                                |
|                |                                             | PPS_Sum           | PPS Derivatives - Total number of youth-reported psychotic-like experiences | Depress        | CBCL DSM-5-Oriented Scale - Affective Problems                       |
|                |                                             | PPS_Severity      | PPS Derivatives - The severity score of PPS                                 | Anxitey        | CBCL DSM-5-Oriented Scale - Anxiety Problems                         |
|                |                                             | PPS_Severity_Mean | PPS Derivatives - The mean severity score of PPS                            | SomaticPr      | CBCL DSM-5-Oriented Scale - Somatic Problems                         |
|                |                                             | Mania             | 7-Up Mania Inventory                                                        | ADHD           | CBCL DSM-5-Oriented Scale - Attention Deficit/Hyperactivity Problems |
|                |                                             | UPPS              | UPPS-P Children Short Form (ABCD-version)                                   | Opposite       | CBCL DSM-5-Oriented Scale - Oppositional Defiant Problems            |
|                |                                             | UPPS_LPers        | UPPS-P Subscale - Lack of Perseverance(Sum Score)                           | Conduct        | CBCL DSM-5-Oriented Scale - Conduct Problems                         |
|                |                                             | UPPS_LPlan        | UPPS-P Subscale - Lack of Planning (Sum Score)                              | SCT            | CBCL 2007 Scale - Sluggish Cognitive Tempo                           |
|                |                                             | UPPS_NU           | UPPS-P Subscale - Negative Urgency (Sum Score)                              | OCD            | CBCL 2007 Scale - Obsessive-Compulsive Problems                      |
|                |                                             | UPPS_PU           | UPPS-P Subscale - Positive Urgency (Sum Score)                              | Stress         | CBCL 2007 Scale - Post-traumatic Stress Problems                     |
