...
SDPP.check.package <- function(package_name = c("readxl",
  ...
  if (any(res$status %in% "Not Installed!")){
    ...
    fprintf("|SDPP ParaSet| SDPP-ABCD-TabDat Check Required Packages: Passed!\n")
    fprintf("|SDPP ParaSet| All required R packages have been installed: \n")
    print(res)
  }
  return(res)
}
...
SDPP.Initialize <- function(ProjectDirectory,
  ...
  fprintf('|SDPP ParaSet| Initializing SDPP-ABCD-TabDat......\n')
  fprintf('|SDPP ParaSet| R package: bruceR is a common-used package in this pipeline, which would be included in all steps.\n')
  fprintf("|SDPP ParaSet| SDPP-ABCD-TabDat is a free software developed by Kunru Song (Ph.D. candidate at Beijing Normal University).\n")
  fprintf("|SDPP ParaSet| SDPP-ABCD-TabDat has been used in our published paper: \n")
  fprintf("|SDPP ParaSet| Song K, Zhang JL, Zhou N, et al. Youth Screen Media Activity Patterns and Associations With\n Behavioral Developmental Measures and Resting-state Brain Functional Connectivity. J Am Acad Child Adolesc Psychiatry. 2023;62(9):1051-1063. doi:10.1016/j.jaac.2023.02.014\n")
  fprintf("|SDPP ParaSet| If you would like to use the SDPP-ABCD-TabDat to process your own ABCD data, please kindly cite the abovementioned article.\n")
  fprintf("|SDPP ParaSet| See more details in README and User Manual.\n")
  ...
  fprintf("|SDPP ParaSet| Scripts Executing Date: \t\t %s\n",Sys.time())
  fprintf("|SDPP ParaSet| Running under OS: \t\t %s\n",basic.info$running)
  fprintf("|SDPP ParaSet| Platform: \t\t\t %s\n",basic.info$platform)
  fprintf("|SDPP ParaSet| R Version: \t\t\t %s\n",basic.info$R.version$version.string)
  fprintf("|SDPP ParaSet| Running on Computer Name: \t %s\n",other.info['nodename'])
  fprintf("===============================SDPP-ABCD-TabDat Data Settings=========================================\n")
  fprintf("|SDPP ParaSet| Working Directory: \t\t %s\n",getwd())
  fprintf("|SDPP ParaSet| Project Directory: \t\t\t %s\n",fullfile(ProjectDirectory))
  fprintf("|SDPP ParaSet| Downloaded NDA Data Directory: \t %s\n",fullfile(TabulatedDataDirectory))
  fprintf("|SDPP ParaSet| Output Intermediate Data File Prefix: \t %s\n",Prefix)
  fprintf("|SDPP ParaSet| Output Intermediate Data Directory: \t %s\n",IntermediateDataDir)
  fprintf("|SDPP ParaSet| Output Derivative Files Directory:\t %s\n",ResultsOutputDir)
